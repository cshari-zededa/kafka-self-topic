...
const (
	bootstrapServers = "pkc-41p56.asia-south1.gcp.confluent.cloud:9092"
	ccloudAPIKey     = "QKYXZK4KLHQVOLKB"
	ccloudAPISecret  = "SBmsyT/fKpWVGPMdZE2iTYKewGx+Ypj6jNS77/12ZcUTdbYNfkcKhtCUJtZH7xD6"
)
